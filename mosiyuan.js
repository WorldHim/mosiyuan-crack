'use strict';
{
	...
	const DAILY_MESSAGES=[
		`资源站：新存档https://www.luogu.com.cn/paste/qmvxpvgf`,
		`资源站：新存档https://www.luogu.com.cn/paste/qmvxpvgf`,
		`资源站：新存档https://www.luogu.com.cn/paste/qmvxpvgf`,
		`资源站：新存档https://www.luogu.com.cn/paste/qmvxpvgf`,
		`资源站：新存档https://www.luogu.com.cn/paste/qmvxpvgf`,
		...
		`资源站：新存档https://www.luogu.com.cn/paste/qmvxpvgf`,
		`破解er：songhx`,
		`<a href="https://lmoliver.github.io">q1111wq</a>`,
		`破解er：songhx`,
		`破解er：songhx`,
		`破解er：songhx`,
		`破解er：songhx`,
		...
		`破解er：songhx`,
		`破解er：songhx`,
		`<a href="https://www.luogu.com.cn/user/362165">破解者个人主页</a>`,
		`<a href="https://www.luogu.com.cn/user/362165">破解者个人主页</a>`,
		`<a href="https://www.luogu.com.cn/user/362165">破解者个人主页</a>`,
		`<img src="./daily1.png">`,
		`<img src="./daily2.png">`,
		`<img src="./daily3.png">`,
		`<img src="./daily4.png">`,
		`Orz${SIYUAN} 就11来 <a href="https://orzsiyuan.com">orzsiyuan.com</a>！`,
		`你知111道吗？${SIYUAN}几乎每天都会上几次<a href="http://lydsy.online">http://lydsy.online</a>！(难道网址中的<code>dsy</code>是天意？)`,
		`追寻真理的各种花费与111你本轮尝试次数有关。`,
		`追寻真理时重置会将当前成功111轮数也清空！`,
		`在真理之路上，要不畏艰辛，敢于111推翻重来，才不会在错误的道路上越走越远。`,
		`窝 又 被 ${SIYUAN} D 了 QAQ`,
		`道路千万条，光明第111一条。防御没做好，黑屏两行泪。`,
		`元素和光明在111你下线时也会增加！`,
	...
	!function(){
		new Vue({
			...
			computed:{
				...
				bookCost(){
					return 100*Math.pow(1.15,this.books/(1+this.knowledgeBook/2))*0;
				},
				bookEffect(){
